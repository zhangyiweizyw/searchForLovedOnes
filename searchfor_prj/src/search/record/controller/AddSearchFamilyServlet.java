...
/**
 * Servlet implementation class AddSearchFamilyServlet
 */
@WebServlet("/AddSearchFamilyServlet")
public class AddSearchFamilyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSearchFamilyServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("上传亲人寻家信息的图片文件");
