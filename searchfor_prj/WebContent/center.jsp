...
<body>
		...
		<div class="mail">
			<div class="container">
				<div style="margin-top: 10px; margin-bottom: 10px; font-size: 15px;">
					<a href="index.jsp">首页</a><span></span><span class="red">个人中心</span>
				</div>
				<div class="mail-grids">
					<div class="col-md-6 mail-left wow fadeInRight animated"
						data-wow-delay=".5s">
						<h4>用户名：</h4>
						<p style="font-size: 35px; font-family: 黑体; font-weight: bold;">${pageScope.user.userName}</p>
						<ul>
							<li><i class="glyphicon glyphicon-earphone"
								aria-hidden="true"></i>联系方式<span
								style="font-size: 15px; font-family: 黑体; font-weight: bold;">${user.userTel}</span></li>
							<li><i class="glyphicon glyphicon-envelope"
								aria-hidden="true"></i>电子邮件<span
								style="font-size: 15px; font-family: 黑体; font-weight: bold;">${pageScope.user.userEmail}</span></li>
						</ul>
						<ul>
							<li><i class="glyphicon glyphicon-map-marker"
								aria-hidden="true"></i>用户类型<span
								style="font-size: 15px; font-family: 黑体; font-weight: bold;">${pageScope.user.userType}</span></li>
						</ul>
					</div>
					<div class="col-md-6 mail-left wow fadeInLeft animated"
						data-wow-delay=".5s">
						<h4>意见反馈</h4>
						<p>亲逢官网欢迎您提出宝贵意见！</p>
						<form>
	...
	<div class="copy-section wow fadeInRight animated" data-wow-delay=".5s"">
		<div class="container">
			...
			<p style="font-size: 15px; font-family: 黑体; font-weight: bold;">
				Copyright &copy; 2016.Company name All rights reserved.<a
					target="_blank" href="http://guantaow.taobao.com/"></a><a
					target="_blank" href="http://www.moobnn.com">亲逢</a>
			</p>
		</div>
	</div>
